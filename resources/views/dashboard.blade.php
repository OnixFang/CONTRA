...
<div class="row">
	<div class="col-xs-6 col-md-3">
		<div class="panel panel-default">
			<div class="panel-body easypiechart-panel">
				<h4>Pendiente</h4>
				<div class="easypiechart" id="easypiechart-blue" data-percent="{{((count($pendientes) / count($asignaturas))*100 ) }}" ><span class="percent">{{  ((count($pendientes) / count($asignaturas))*100 )}}%</span></div>
			</div>
		</div>
	</div>
	<div class="col-xs-6 col-md-3">
	...
	<div class="col-xs-6 col-md-3">
		<div class="panel panel-default">
			<div class="panel-body easypiechart-panel">
				<h4>Completado</h4>
				<div class="easypiechart" id="easypiechart-red" data-percent="{{  ((count($aprobadas) / count($asignaturas))*100 )}}%" ><span class="percent">{{  ((count($aprobadas) / count($asignaturas))*100 )}}%</span></div>
			</div>
		</div>
	</div>
</div><!--/.row-->
